...
</style></head><body><main class="shell"><div class="heading"><h1>Vento sull’Isola d’Elba</h1><div class="meta" id="time"></div><div class="meta map-help"><div>Freccia: verso del moto · numero: km/h</div><div class="coast-key"><span>Costa non esposta</span><span class="onshore">Onshore nelle ultime 6 ore</span></div></div><div class="legend"><span class="key">Velocità (km/h)</span><span class="key gust">Raffica (km/h)</span><span class="key predictability">Prevedibilità ensemble (%)</span><span class="key direction">Verso e componente nord/sud (km/h)</span></div></div>
