...
<canvas class="chart direction-chart" id="directionChart" role="img" aria-label="Direzione del vento ora per ora: proiezione nord sud da meno uno a piu uno, indipendente dalla velocita"></canvas>
